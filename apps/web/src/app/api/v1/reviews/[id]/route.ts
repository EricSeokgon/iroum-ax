// @MX:NOTE: BFF 리뷰 상세 프록시 — ReviewDetail 모달이 클릭 시점에 호출.
// SPEC-AX-WEB-001 Phase E REQ-WEB-006 GET /api/v1/reviews/{id} 정합.
 ...
 * 영문/숫자/하이픈/언더스코어 64자 이하로 제한 (reports/category/[id] 가드 패턴 정합).
 */
