// @MX:NOTE: BFF 범주 리포트 프록시 — ReportView가 범주 선택 시 호출.
// SPEC-AX-WEB-001 REQ-WEB-005 §1.3 GET /api/v1/reports/category/{id} 정합.
...
export async function GET(
  ...
  const targetUrl = new URL(
    `/api/v1/reports/category/${encodeURIComponent(id)}`,
    getBackendBaseUrl(),
  );
